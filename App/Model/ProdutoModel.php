...
class ProdutoModel extends Model
{
    ...
    public function setDescricao($_desc)
    {
        if (!empty($_desc))
            ...
            $this->validation_erros[] = "Desculpe, informe a descrição.";
    }
    ...
    public function setPreco($_preco)
    {
        if (!empty($_preco))
            ...
            $this->validation_erros[] = "Desculpe, informe o preço.";
    }
    ...
    public function setCategoria(int $_id_categoria)
    {
        if (!empty($_id_categoria))
            ...
            $this->validation_erros[] = "Desculpe, selecione a categoria.";
    }
    ...
    public function setMarca(int $_id_marca)
    {
        if (!empty($_id_marca))
            ...
            $this->validation_erros[] = "Desculpe, selecione a marca.";
    }
    ...
    public function delete ($id)
    {
        try {
            ...
            $this->validation_erros[] = $e->getMessage();
